...
test('Testing filtred', () => {
  expect(filtred(courses, requiredRange1)).toBe(expectedRange1),
  expect(filtred(courses, requiredRange2)).toBe(expectedRange2),
  expect(filtred(courses, requiredRange3)).toBe(expectedRange3);
});
